...
import { UserPlus, Mail, Lock, AlertCircle, Loader2, ArrowRight } from "lucide-react";
...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#fdfbf7]">
      ...
      <div className="absolute top-10 right-10 w-64 h-64 bg-[#8a1c31]/5 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-[#ffb800]/10 rounded-full blur-3xl animate-pulse delay-700"></div>

      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="max-w-md w-full mx-4 z-10 my-12"
      >
        <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-[0_20px_50px_rgba(138,28,49,0.15)] border border-white/50 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#8a1c31]/10 mb-6 group transition-all duration-300 hover:scale-110">
              <UserPlus className="h-8 w-8 text-[#8a1c31]" />
            </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-4 bg-white/80 text-stone-400 font-medium">OR CONTINUE WITH</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              >
                ...
                <span className="text-stone-700 font-medium text-sm">Sign up with Google</span>
              </button>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-stone-500">
              ...
              <Link to="/login" className="font-semibold text-[#8a1c31] hover:underline decoration-2 underline-offset-4 transition-all">
                Log in
              </Link>
            </p>
          </div>
